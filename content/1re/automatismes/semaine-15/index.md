---
title: "Semaine 15 — Fonctions, variations et statistiques"
...
<img src="graphe_f04_3.svg" alt="Graphe" style="display:block;margin:1rem auto;max-width:360px">
...
---CORR---
$\bullet$ Le minimum de $f$ est $-4$. <br>
 Cette affirmation est correcte : <br>
Le point le plus bas de la courbe a pour ordonnée $-4$. C'est le minimum de $f$.<br>

$\bullet$ $f(1{,}2) \times f(1{,}6) < 0$<br>
 Cette affirmation est fausse : <br>
$f(1{,}2) < 0$ et $f(1{,}6) < 0$, donc le produit est positif.<br>
$\bullet$ L'équation $f(x)=0$ admet une unique solution.<br>
 Cette affirmation est fausse : <br>
L'équation $f(x)=0$ admet deux solutions car la courbe coupe deux fois l'axe des abscisses pour des valeurs opposées en $-2$ et $2$.<br>
...
$B = \dfrac{38}{100} = 0,38$<br><br>

$C = \dfrac{7}{20} = \dfrac{7 \times 5}{20\times 5} = \dfrac{35}{100}=0,35$<br><br>
...
---Q---
Soit $h$ la fonction définie par : $h(x)=-6x+3$. <br>
$h(-3)+h(1)$ est égal à :
...
---CORR---
La série triée par ordre croissant est : $5$ ; $6$ ; $8$ ; $14$ ; $15$ ; $16$ ; $17$ ; $20$ ; $23$. <br>
La série contient $9$ valeurs. <br>
...
<img src="graphe_f04_3_devoir.svg" alt="Graphe" style="display:block;margin:1rem auto;max-width:360px">
...
{{< qcm correct="3" type="auto" >}}
---Q---
Soit $k$ la fonction définie par : $k(x)=6x-5$. <br>
$k(0)+k(3)$ est égal à :
