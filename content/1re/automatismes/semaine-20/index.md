...
On considère les trois fonctions définies par : 
 ...
 $f_1\ :\ x \longmapsto x^2-(x+3)(x-5)\ \ \ \ \ \ \ \ f_2\ :\ x \longmapsto 5\sqrt{x}+3\ \ \ \ \ \ \ \ f_3\ :\ x \longmapsto\dfrac{3}{x}-6$<br>
...
\begin{multicols}{2}
 ...
 <img src="graphe_c10_6_devoir.svg" alt="Graphe" style="display:block;margin:1rem auto;max-width:360px">
 \end{multicols}
...
Pour résoudre graphiquement cette inéquation : 
 ...
 <img src="graphe_c10_6_corr.png" alt="Graphe" style="display:block;margin:1rem auto;max-width:360px">
...
On considère les trois fonctions définies par : 
 ...
 $f_1\ :\ x \longmapsto x^2-(x+2)(x-4)\ \ \ \ \ \ \ \ f_2\ :\ x \longmapsto 2\sqrt{x}+4\ \ \ \ \ \ \ \ f_3\ :\ x \longmapsto\dfrac{2}{x}-7$ <br>
 On peut affirmer que :
