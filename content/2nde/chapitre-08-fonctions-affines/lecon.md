...
</div><img src="/mabemat/figures/2nde/chapitre-05/fig1.svg" alt="figure 1" style="display:inline-block; vertical-align:middle; width:calc(49% - 12px); max-height:300px; max-width:100%;">
</div>
</div>
...
<div class="environment-content">
<ol>
<li>Soit $f$ la fonction affine définie pour tout réel $x$ par $f(x) = 3x - 4$.
<ol style="list-style-type:lower-alpha;">
<li>Quel est le sens de variation de la fonction affine $f$ ?<br>
$f$ est une fonction affine telle que $a = 3$, donc $a > 0$. La fonction $f$ est donc croissante sur $\R$.</li>
<li>Dresser son tableau de variation.<br>
<img src="/mabemat/figures/2nde/chapitre-05/tabvar-3x-4.svg" alt="tableau de variation de f(x)=3x-4" style="max-height:130px; max-width:100%; margin-top:6px;"></li>
</ol>
</li>
<li>Sachant que $\sqrt{3} < \sqrt{7}$, peut-on comparer sans calcul les nombres $3\sqrt{3} - 4$ et $3\sqrt{7} - 4$ ?<br>
On remarque que $3\sqrt{3} - 4 = f(\sqrt{3})$ et $3\sqrt{7} - 4 = f(\sqrt{7})$.<br>
Or $\sqrt{3} < \sqrt{7}$. Comme $f$ est croissante, on en déduit que $f(\sqrt{3}) < f(\sqrt{7})$.<br>
On en conclut que $3\sqrt{3} - 4 < 3\sqrt{7} - 4$.</li>
</ol>
</div>
</div>
...
<img src="/mabemat/figures/2nde/chapitre-05/1.png" alt="figure 1" style="max-height:180px; max-width:100%;">
<img src="/mabemat/figures/2nde/chapitre-05/2.png" alt="figure 2" style="max-height:250px; max-width:100%; margin-top:10px;">
</div>
...
<div style="text-align:center;">
<img src="/mabemat/figures/2nde/chapitre-05/3.png" alt="figure 3" style="max-height:200px; max-width:100%;">
</div>
</div>
</div>
...
<div style="display:flex; gap:2rem; align-items:flex-start; flex-wrap:wrap; margin:1rem 0;">
<div style="overflow-x:auto;">
<table class="signe">
<tr><th>$x$</th><td>$-\infty$</td><td></td><td>$-2$</td><td></td><td>$\dfrac{1}{2}$</td><td></td><td>$+\infty$</td></tr>
<tr><th>$3-6x$</th><td></td><td class="pos">$+$</td><td class="pos">$+$</td><td class="pos">$+$</td><td>$0$</td><td class="neg">$-$</td><td></td></tr>
<tr><th>$x+2$</th><td></td><td class="neg">$-$</td><td>$0$</td><td class="pos">$+$</td><td class="pos">$+$</td><td class="pos">$+$</td><td></td></tr>
<tr><th>$(3-6x)(x+2)$</th><td></td><td class="neg">$-$</td><td>$0$</td><td class="pos">$+$</td><td>$0$</td><td class="neg">$-$</td><td></td></tr>
</table>
</div>
<div>
On en déduit que $(3-6x)(x+2)>0$ pour $x\in \left] -2 \; ; \; \dfrac{1}{2}\right[$.<br>
L'ensemble des solutions de l'inéquation $(3-6x)(x + 2) > 0$ est $S= \left] -2 \; ; \; \dfrac{1}{2}\right[$.
</div>
</div>
</div>
</div>
...
<table class="signe">
<tr><th>$x$</th><td>$-\infty$</td><td></td><td>$\dfrac{1}{3}$</td><td></td><td>$\dfrac{2}{3}$</td><td></td><td>$+\infty$</td></tr>
<tr><th>$2-6x$</th><td></td><td class="pos">$+$</td><td>$0$</td><td class="neg">$-$</td><td class="barre">$||$</td><td class="neg">$-$</td><td></td></tr>
<tr><th>$3x-2$</th><td></td><td class="neg">$-$</td><td class="neg">$-$</td><td class="neg">$-$</td><td class="barre">$||$</td><td class="pos">$+$</td><td></td></tr>
<tr><th>$\dfrac{2-6x}{3x-2}$</th><td></td><td class="neg">$-$</td><td>$0$</td><td class="pos">$+$</td><td class="barre">$||$</td><td class="neg">$-$</td><td></td></tr>
</table>
</div>
La double-barre dans le tableau signifie que le quotient n'est pas défini pour $x=\dfrac{2}{3}$.<br>
<br>
On en déduit que $\dfrac{2-6x}{3x-2}\leq 0$ pour $x\in \left] -\infty \; ; \; \dfrac{1}{3}\right] \cup \left] \dfrac{2}{3} \; ; \; +\infty \right[$.<br>
<br>
L'ensemble des solutions de l'inéquation $\dfrac{2-6x}{3x-2}\leq 0$ est $S= \left] -\infty \; ; \; \dfrac{1}{3}\right] \cup \left] \dfrac{2}{3} \; ; \; +\infty \right[$.
</div>
</div>
...
<div class="environment-content">
<div style="text-align:center;">
<img src="/mabemat/figures/2nde/chapitre-05/fig7.svg" alt="figure 7" style="max-height:400px; max-width:100%;">
</div>
