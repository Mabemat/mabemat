...
\begin{Exemple}
La longueur d'un cercle de rayon 7 cm vaut : \ligne
...
\begin{itemize}
\item Le point C $\ldots$ au disque.
\item Le point C $\ldots$ au cercle.
\item Le point H $\ldots$ au disque et au cercle.
\item Le point G $\ldots$ au disque.
\end{itemize}
\end{enumerate}
