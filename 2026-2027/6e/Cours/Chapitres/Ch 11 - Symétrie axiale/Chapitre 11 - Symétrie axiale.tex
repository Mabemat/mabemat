...
\begin{center}
 \begin{tikzpicture}[baseline,scale = 0.4]
	...
	\draw[color={Couleur6},line width = 0.5] (5.5,-5.5)--(5.782843,-5.782843)--(6.065685,-5.5)--(5.782843,-5.217157)--cycle;
\draw [color={Couleur6}] (4.75,-6.25) node[anchor = center , rotate = 45] {X};
\draw [color={Couleur6}] (6.25,-4.75) node[anchor = center , rotate = 45] {X};

	\draw[color={Couleur5},line width = 0.5] (3.5,-3.5)--(3.217157,-3.217157)--(2.934315,-3.5)--(3.217157,-3.782843)--cycle;
\draw [color={Couleur5}] (5.25,-1.75) node[anchor = center , rotate = -315] {O};
\draw [color={Couleur5}] (1.75,-5.25) node[anchor = center , rotate = -315] {O};

	
	\draw[color ={Couleur6}, dashed] (4,-7)--(7,-4);
	\draw[color ={Couleur5}, dashed] (7,0)--(0,-7);
	...
	\draw [color={Couleur10}] (-4.310352,4.393112) node[anchor = center, rotate = 0] {I'};
	\draw [color={Couleur10}] (7.484476,-4.134577) node[anchor = center, rotate = 0] {J'};
	\draw [color={Couleur10}] (-0.104218,-7.486352) node[anchor = center, rotate = 0] {K'};
	\draw[color={black},line width = 1] (-4,4)--(4,-7)--(7,0)--cycle;
	\draw[color={Couleur10},line width = 1] (-4,4)--(7,-4)--(0,-7)--cycle;
...
\begin{center}
 \begin{tikzpicture}[baseline,scale = 0.5]
	...
	\draw[color={black}] (-35.35533905932737,35.35533905932737)--(36.35533905932737,-36.35533905932737);
	\draw[color={gray},line width = 0.5] (-2.5,2.5)--(-2.782843,2.782843)--(-3.065685,2.5)--(-2.782843,2.217157)--cycle;
\draw [color={gray}] (-0.75,4.25) node[anchor = center, rotate = -315] {|};
\draw [color={gray}] (-4.25,0.75) node[anchor = center, rotate = -315] {|};

	\draw[color={gray},line width = 0.5] (4,-4)--(4.282843,-4.282843)--(4.565685,-4)--(4.282843,-3.717157)--cycle;
\draw [color={gray}] (2,-6) node[anchor = center , rotate = 45] {X};
\draw [color={gray}] (6,-2) node[anchor = center , rotate = 45] {X};

	\draw[color={gray},line width = 0.5] (2,-2)--(1.717157,-1.717157)--(1.434315,-2)--(1.717157,-2.282843)--cycle;
\draw [color={gray}] (3.5,-0.5) node[anchor = center, rotate = -315] {O};
\draw [color={gray}] (0.5,-3.5) node[anchor = center, rotate = -315] {O};

	\draw[color ={gray}, dashed] (1,6)--(-6,-1);
	\draw[color ={gray}, dashed] (0,-8)--(8,0);
	\draw[color ={gray}, dashed] (5,1)--(-1,-5);
	...
	\draw [color={Couleur10}] (-6.492109,-0.922299) node[anchor = center , rotate = 0] {M'};
	\draw [color={Couleur10}] (8.480671,0.125392) node[anchor = center , rotate = 0] {N'};
	\draw [color={Couleur10}] (-1.20187,-5.454208) node[anchor = center , rotate = 0] {O'};
	\draw[color={black}] (1,6)--(0,-8)--(5,1)--cycle;
	\draw[color={Couleur10}, line width = 1] (-6,-1)--(8,0)--(-1,-5)--cycle;
...
\begin{Exemple}
 ...
 Les points $J'$, $V'$, $N'$ sont les images respectives de $J$, $V$, $N$ par la symétrie d'axe $(d)$.\\Or, la symétrie axiale conserve les angles.\\Donc l'angle $\widehat{J'V'N'}$ mesure lui aussi $50$ $^\circ$ .

\medskip
Le segment [$VN$] mesure $4{,}4\text{ cm}$.\\Or, la symétrie axiale conserve les longueurs.\\Donc le segment [$V'N'$] mesure lui aussi $4{,}4\text{ cm}$.
