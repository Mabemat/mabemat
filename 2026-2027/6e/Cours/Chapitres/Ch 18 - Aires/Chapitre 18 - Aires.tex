...
\item $54,2\text{ m}^2 = 54,2 \times 100\text{ dm}^2 = 5 420\text{ dm}^2$
\item $7,5\text{ cm}^2 = 7,5 \div 100\text{ dm}^2= 0,075\text{ dm}^2$
\end{itemize}
\end{multicols}
\vspace{-0.6cm}
\end{Exemples}
...
\vspace{-2cm}
\begin{align*}
\textcolor{Couleur8}{\bullet} A_{\text{LKJI}}&= c \times c\\
&= 8 \times 8\\
&= 64 \text{ cm²}
\end{align*}
\end{minipage} \hfill
...
\begin{minipage}{0.15\textwidth}
\begin{align*}
\textcolor{Couleur8}{\bullet}A_{\text{VUTS}}&= L \times l \\
&= 10 \times 5\\
&= 50 \text{ cm²}
\end{align*}
\end{minipage} \hfill
