...
Ce problème est de type multiplicatif car on doit multiplier le prix d'un livre par 5 pour obtenir 18 €. Ainsi, chaque livre coûte 18 € ÷ 5 soit 3,60 €. C'est un exemple de résolution de problème mettant en œuvre de la proportionnalité.
...
\end{minipage} \hfill \begin{minipage}[c]{0.65\textwidth}
...
\node at (2.25,-0.7) {Ce que j'ai perdu.};

\draw[fill=Couleur10!15, draw=Couleur10,very thick] (4.5,-1.1) rectangle (10.5,-0.3);
\node at (7.5,-0.7) {Il me reste 20 billes.};

% Barre principale avec titre
\draw[fill=Couleur10!50, draw=Couleur10,very thick] (0,0.5) rectangle (10.5,1.3);
\node at (5.25,0.9) {\textbf{Total des billes}};
\end{tikzpicture}
\end{center}
\end{minipage} 
$ $\\
 On constate que les 20 billes qui restent correspondent à quatre parts. 20 ÷ 4 = 5. \\
 Chaque part représente donc cinq billes. J'ai perdu trois parts, ce qui représente 15 billes (3 × 5).
...
\node[left] at (-3,2.4) {\textbf{L'aîné}};
\node at (0,2.4) {Unité};
...
\node at (7,1.9) {\textbf{Total}};
\node at (7,1.1) {\textbf{75 €}};

% Le cadet
\draw[fill=Couleur7!40, draw=Couleur7,very thick] (-3,1.2) rectangle (3,2);
\node[left] at (-3,1.6) {\textbf{Le cadet}};
\node at (0,1.6) {Unité};
...
\node[left] at (-3,0.8) {\textbf{Le benjamin}};
\node at (0,0.8) {Unité};
...
Par conséquent, trois unités ensemble valent 75 € - 30 € = 45 € et ainsi une unité vaut 45 € ÷ 3 soit 15 €. Le benjamin aura 15 €, le cadet 25 € et l'aîné 35 €.
...
Grâce à la balance n°2 initiale, on en déduit qu'une orange pèse 90 g — 40 g soit 50 g.
...
\hline
\textcolor{Couleur10}{\textbf{1}} & 6 \\
\hline
\textcolor{Couleur10}{\textbf{2}} & $6 + \textcolor{Couleur10}{\textbf{1}} \times 5$ \\
\hline
\textcolor{Couleur10}{\textbf{3}} & $6 + 5 + 5 = 6 + \textcolor{Couleur10}{\textbf{2}} \times 5$ \\
\hline
\textcolor{Couleur10}{\textbf{4}} & $6 + 5 + 5 + 5 = 6 + \textcolor{Couleur10}{\textbf{3}} \times 5$ \\
\hline
\textbf{...} & \\
\hline
\textcolor{Couleur10}{\textbf{32}} & $6 + 5 + \ldots = 6 + \textcolor{Couleur10}{\textbf{31}} \times 5$ \\
\hline
\end{tabular}
\end{center}
\end{minipage}
