...
\cellcolor{Couleur8!25}Cube & \cellcolor{Couleur8!25}Pavé droit & \cellcolor{Couleur8!25}Prisme droit & \cellcolor{Couleur8!25}Cylindre & \cellcolor{Couleur8!25}Pyramide & \cellcolor{Couleur8!25}Cône& \cellcolor{Couleur8!25}Boule \\

\hline

\rule{0pt}{2.5cm}\includegraphics[scale=.35]{IMG/11} & \includegraphics[scale=.35]{IMG/12} & \includegraphics[scale=.32]{IMG/13} & \includegraphics[scale=.35]{IMG/14} & \includegraphics[scale=.33]{IMG/15} & \includegraphics[scale=.34]{IMG/16}& \includegraphics[scale=.35]{IMG/17}\\
...
\item $11,2$ m³ = $11,2 \times 1\,000$ dm³ = $11\,200$ dm³
\item $6,5$cm³ = $6,5 \div 1000 000$m³ = $0,0000065$m³
\end{itemize}
\end{multicols}
\vspace{-0.6cm}
\end{Exemples}
