...
La \textbf{population} est l'ensemble des élèves de la classe de 6e. Le \textbf{caractère} étudié est la saison de naissance. L'\textbf{effectif total} est la somme des effectifs de chaque saison : 8 + 12 + 6 + 4 = 30.
On lit, par exemple, que \textbf{\textcolor{Couleur8}{12}} élèves sont nés au printemps.
\end{Exemple}
...
On lit par exemple que \textbf{\textcolor{Couleur8}{8}} filles sont nées au printemps. Cet effectif de 8 correspond à deux caractères : le genre (fille) et la saison (printemps).
...
On lit, par exemple, qu'il y a 140 élèves demi-pensionnaires le mardi.
...
On lit, par exemple, qu'il y a 14,2 \% de pistes qui sont vertes et que plus d'un quart des pistes sont rouges.
...
À 10 m des enceintes, l'intensité est d'environ 90 dB.
