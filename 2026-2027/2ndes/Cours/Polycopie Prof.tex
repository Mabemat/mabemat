...
\geometry{
	...
	inner=1.5cm, % Inner margin (left on odd pages, right on even or left in oneside mode)
...
\newenvironment{Théorème*}{\begin{tBox}\begin{theoremeT*}}{\end{theoremeT*}\end{tBox}}
\newenvironment{Exercice}{\begin{eBox}\begin{exerciseT}}{\hfill{\color{Couleur6}\tiny\ensuremath{\blacksquare}}\end{exerciseT}\end{eBox}}		
\newenvironment{Théorèmes}{\begin{tBox}\begin{theoremesT}}{\end{theoremesT}\end{tBox}}
\newenvironment{Théorèmes*}{\begin{tBox}\begin{theoremesT*}}{\end{theoremesT*}\end{tBox}}
\newenvironment{Exercices}{\begin{eBox}\begin{exercisesT}}{\hfill{\color{Couleur1}\tiny\ensuremath{\blacksquare}}\end{exercisesT}\end{eBox}}		
...
%% 01
\cleardoublepage
\import{Chapitres/Ch 1 - Ensembles de nombre/}{Chapitre 1 - Ensembles de nombre.tex}

%% 02
\cleardoublepage
\import{Chapitres/Ch 2 - Notion de fonction/}{Chapitre 2 - Notion de fonction.tex}

%% 03
\cleardoublepage
\import{Chapitres/Ch 3 - Informations chiffrées/}{Chapitre 3 - Informations chiffrées.tex}

%% 04
\cleardoublepage
\import{Chapitres/Ch 4 - Fonctions affines/}{Chapitre 4 - Fonctions affines.tex}

%% 05
\cleardoublepage
\import{Chapitres/Ch 5 - Vecteurs et translations/}{Chapitre 5 - Vecteurs et translations.tex}

%% 06
\cleardoublepage
\import{Chapitres/Ch 6 - Utilisation du calcul littéral/}{Chapitre 6 - Utilisation du calcul litteral.tex}

%% 07
\cleardoublepage
\import{Chapitres/Ch 7 - Fonction carré/}{Chapitre 7 - Fonction carre.tex}

%% 08
\cleardoublepage
\import{Chapitres/Ch 8 - Statistiques/}{Chapitre 8 - Staristiques.tex}

%% 09
\cleardoublepage
\import{Chapitres/Ch 9 - Vecteurs et repérage/}{Chapitre 9 - Vecteurs et repérage.tex}

%% 10
\cleardoublepage
\import{Chapitres/Ch 10 - Arithmétique/}{Chapitre 10 - Arithmétique.tex}

%% 11
\cleardoublepage
\import{Chapitres/Ch 11 - Racines carrées et valeurs absolues/}{Chapitre 11 - Racines carrées et valeurs absolues.tex}

%% 12
\cleardoublepage
\import{Chapitres/Ch 12 - Probabilités/}{Chapitre 12 - Probabilités.tex}

%% 13
\cleardoublepage
\import{Chapitres/Ch 13 - Équations de droites et systèmes d'équations/}{Chapitre 13 - Équations de droites et systèmes d'équations.tex}

%% 14
\cleardoublepage
\import{Chapitres/Ch 14 - Fonction inverse/}{Chapitre 14 - Fonction inverse.tex}
