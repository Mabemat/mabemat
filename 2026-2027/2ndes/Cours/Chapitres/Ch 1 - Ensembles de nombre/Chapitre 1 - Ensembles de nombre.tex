...
Nombres \textbf{entiers naturels} & $\N$ &  Nombres entiers positifs ou nuls  &
 0 ; 1 ; 2 ; 3 ; 4 ; 5 \\ 
\hline 
Nombres \textbf{entiers relatifs} & $\Z$ &  Nombres entiers positifs ou négatifs ou nuls  & -8 ; -3 ; 0 ; 1 ; 6 \\ 
\hline 
Nombres \textbf{décimaux} & $\D$ &  Nombres de la forme $\dfrac{a}{10^n}$, $a \in \Z$ et $n \in \N$  &  $-2,1=-\dfrac{21}{10} \text{ }$ ; $\dfrac{2}{5}=\dfrac{4}{10}$ ; $5=\dfrac{5}{1}$ \\ 
\hline 
Nombres \textbf{rationnels} & $\Q$ & Nombres de la forme $\dfrac{a}{b}$, $a \in \Z$ et $b \in \N$, $b \neq 0$ & $\dfrac{1}{3}$ ; $5=\dfrac{5}{1}$ ; $-2,1=-\dfrac{21}{10}$ \\ 
\hline 
Nombres \textbf{réels} & $\R$ & Tous les nombres connus en 2nde  & $5$ ; $-8$ ; $-2,1=-\dfrac{21}{10}$ ; $\dfrac{1}{3}$ ; $\sqrt{2}$ ; $ \pi $ \\ 
\hline 
\end{tabular} 
\end{center}
\end{Définition}
...
\item 0,125 est un nombre rationnel : son écriture décimale comporte un nombre fini de décimales.
\item $\dfrac{127}{11} = 11,545454...$ est un nombre rationnel : l'écriture décimale comporte une période. 
\end{itemize}
\end{Exemple}
...
\begin{multicols}{2}
\begin{itemize}[label=\textcolor{Couleur10}{$\bullet$}]
\item $]-\infty\mathpunct{} ;5]\cap[2\mathpunct{} ;6]=[2\mathpunct{} ;5]$
\item $]-\infty\mathpunct{} ;5]\cap]2\mathpunct{} ;6]=]2\mathpunct{} ;5]$
\item $[-3\mathpunct{} ;4]\cap[4\mathpunct{} ;6]=\{4\}$
\item $[12\mathpunct{} ;56]\cap[-3\mathpunct{} ;0]=\emptyset$ (ensemble vide)
\end{itemize}
\end{multicols}
\end{Exemples}
...
\begin{multicols}{2}
\begin{itemize}[label=\textcolor{Couleur10}{$\bullet$}]
\item $[-3\mathpunct{} ;4]\cup[4\mathpunct{} ;6]=[-3\mathpunct{} ;6]$
\item $]-\infty\mathpunct{} ;5]\cup[4\mathpunct{} ;10]=]-\infty\mathpunct{} ;10]$
\item $]-\infty\mathpunct{} ;1[\cup]1\mathpunct{} ;+\infty[=\R\setminus\{1\}$ 
\item  $]-\infty\mathpunct{} ;0[\cup]0\mathpunct{} ;+\infty[=\R^\ast$
\end{itemize}
\end{multicols}
\end{Exemples}
...
\item $10^5=10 \times 10 \times 10 \times 10 \times 10=100000$
\item $2^{-4}=\dfrac{1}{2^4}=\dfrac{1}{16}$
\item $(-5)^{-2}=\dfrac{1}{(-5)^2}=\dfrac{1}{25}$
\item $10^{-3}=\dfrac{1}{10^3}=\dfrac{1}{1000}=0,001$
\end{itemize}
\end{multicols}
\end{Exemples}
...
\begin{multicols}{2}
\begin{itemize}[label=\textcolor{Couleur10}{$\bullet$}]
\item $3^2\times 3^3=3^{2+3}=3^5$
\item $\dfrac{10^3}{10^2}={10}^{3-2}=10$
\item $(2\times x)^{3}=2^3\times x^3=8\times x^3$
\item $(10^3)^2=10^{3\times 2}=10^6=1000000$
\item $5^6\times 9^6=(5\times 9)^6=45^6$
\end{itemize}
\end{multicols}
\end{Exemples}
...
\begin{multicols}{2}
\begin{itemize}[label=\textcolor{Couleur10}{$\bullet$}]
\item $823 951=8,239 51\times 10^{5}$
\item $-10 500=-1,05\times 10^{4}$
\item $0, 123 456=1,234 56\times 10^{-1}$
\item $-0,000 123=-1,23\times 10^{-4}$
\end{itemize}
\end{multicols}
\end{Exemples}
...
\begin{Exemple}
$4\leq 7$ alors $4{\color{Couleur10}{+5}}\leq 7{\color{Couleur10}{+5}}$ c'est-à-dire $9\leq 12$.
\end{Exemple}
...
\leavevmode\vspace{-\baselineskip}
\begin{itemize}
\item $7\geq4$ alors $7 \times 3 \geq 4 \times 3$. On a : $21>12$.
\item $7\geq 4$ alors $7 \times {\color{Couleur10}{(-3)}}  {\color{Couleur10}{\leq}} 4  \times {\color{Couleur10}{(-3)}}$. On a : $-21 \leq -12$.
\end{itemize}
\end{Exemple}
...
\begin{Exemple}
\begin{tabular}{C{8cm}|C{9cm}} \arrayrulecolor{Couleur10}
Résoudre dans $\R$ : $4x+5\leq 21$ & Résoudre dans $\R$ : $-5x+7< 28$ \\
{$\begin{aligned}
4x +5 {\color{Couleur10}{-5}}&\leq 21 {\color{Couleur10}{-5}} \\
4x & \leq 16
\end{aligned}$}  &{$\begin{aligned}
-5x +7 {\color{Couleur10}{-7}}&< 28 {\color{Couleur10}{-7}} \\
-5x & < 21
\end{aligned}$} \\
$4>0$, l'ordre de l'inégalité est conservé & $-5<0$, l'ordre de l'inégalité est changé \\
$\dfrac{4x}{ {\color{Couleur10}{4}}}\leq \dfrac{16}{ {\color{Couleur10}{4}}}$ & $\dfrac{-5x}{ {\color{Couleur10}{-5}}}{\color{Couleur10}{>}} \dfrac{21}{ {\color{Couleur10}{-5}}}$ \\
$x\leq 4$. &  $x> -\dfrac{21}{5}$. \\

L'ensemble des solutions est donc : $S=]-\infty;4]$. & L'ensemble des solutions est donc : $S=\left]-\dfrac{21}{5} \mathpunct{} ; +\infty \right[$.
\end{tabular}
