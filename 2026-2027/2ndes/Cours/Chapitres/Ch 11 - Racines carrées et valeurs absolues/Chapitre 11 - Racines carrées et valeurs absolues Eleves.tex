...
\item $2\sqrt{2}\times 4\sqrt{18}=$ \ligne

\item $\left(4\sqrt{5}\right)^2=$ \ligne

\item $3\sqrt{125}=$ \ligne
...
\begin{multicols}{2}
\begin{itemize}[label=\textcolor{Couleur8}{$\bullet$}]
\item $\dfrac{\sqrt{32}\times\sqrt{10}}{\sqrt{80}}=$ \ligne

\item $\sqrt{\dfrac{50}{242}}=$ \ligne
...
\end{Propriété}
\begin{Exemple}
L'équation $\sqrt{x}=3$ a pour ensemble de solutions \ligne
...
\leavevmode\vspace{-\baselineskip}
\begin{itemize}[label=\textcolor{Couleur8}{$\bullet$}]
\item L'inéquation $\sqrt{x}\leq 4$ a pour ensemble de solutions \ligne

\item L'inéquation $\sqrt{x}>5$ a pour ensemble de solutions \ligne

\item L'inéquation $-4\sqrt{x}-5<7$ qui s'écrit aussi \ligne
...
\begin{tabular}{>{\centering\arraybackslash}m{5cm}>{\centering\arraybackslash}m{5cm}>{\centering\arraybackslash}m{6cm}}
 $\vert 24 \vert =$ \pointille{2cm}
& $\vert -19,2 \vert =$ \pointille{2cm}
& $\vert x-5 \vert =$ \pointille{3cm} 
\end{tabular}
\end{Exemple}
...
$\sqrt{(5,1)^2}=$ \pointille{2cm}
& $\sqrt{(12-2x)^2}=$ \pointille{5cm} \\
$\sqrt{ (-2)^2} =$ \pointille{2cm} & 
\end{tabular}
...
\begin{Exemple}
La distance entre $-3$ et $7$ est \ligne
...
\begin{Exemple}
Soit un réel $x$ tel que $\vert x-8 \vert \leq 3$\ligne
