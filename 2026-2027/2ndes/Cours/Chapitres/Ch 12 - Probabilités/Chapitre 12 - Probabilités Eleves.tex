...
\item L'évènement : \og le roi de c{\oe}ur est tiré \fg{} est un évènement \ligne

\item L'évènement : \og un trois est tiré \fg{} est un évènement \ligne

\item L'évènement : \og une carte du jeu est tirée \fg{} est un évènement \ligne

\item L'évènement contraire de : \og le 10 de c{\oe}ur est tiré \fg{} est : \ligne

\item Un évènement non élémentaire est par exemple : \ligne

\item Deux évènements incompatibles sont par exemple : \ligne
...
\cline{2-4}  
\multicolumn{1}{c|}{} &\phantom{ Cardio-vasculaire} & \phantom{Non cardio-vasculaire} & Total \\  
\hline 
\phantom{Cholestérol} &  &  &  \\  
\hline 
\phantom{Non cholestérol} &  &  &  \\  
\hline 
Total &  &  &  \\ 
\hline
\end{tabular}
