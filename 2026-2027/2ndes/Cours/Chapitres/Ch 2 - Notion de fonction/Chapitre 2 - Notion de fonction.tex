...
\begin{itemize}[label=\textcolor{Couleur10}{$\bullet$}]
    \item $g(0) = 3$ : 3 est l'image de 0 par $g$ et 0 est un antécédent de 3 par $g$.
    
    \item On cherche un antécédent de 7 par $g$. On cherche donc à résoudre l'équation $g(x) = 7$.
\end{itemize}
    \columnbreak
    \vspace{-0.5cm}
\begin{align*}
...
\begin{itemize}[label=\textcolor{Couleur10}{$\bullet$}]
    \item Le domaine de définition de $h$ est $] -4, 8]$.
    \item Le point de coordonnées $(-1, -2)$ est sur la courbe, ce qui signifie que $h(-1) = -2$.
    \item L'image de $1$ par $h$ est $3$.
    \item $-2$ a trois antécédents par $h$ : $-1$, $5$ et $7$. $6$ n'a pas d'antécédent par $h$.
\end{itemize}
\end{Exemple}
...
$ $ \\
\begin{itemize}[label=\textcolor{Couleur10}{$\bullet$}]
    \item Le domaine de définition se lit sur la première ligne : $D = [-4; 5]$
    \item $f(-4) = 2$, $f(0) = -1$, $f(2) = 0$, $f(5) = -2$
    \item On souhaite encadrer $f(1)$. On sait que $1 \in [0; 2]$ et $f$ est croissante sur cet intervalle. \\
    On a donc $f(0) \leq f(1) \leq f(2)$, c'est-à-dire $-1 \leq f(1) \leq 0$.
\end{itemize}
\end{minipage}
...
\begin{tikzpicture}[scale=1]
   \tkzTabInit{$x$ / 1 , Variations / 1.5, Signe / 1}{$-5$, $ -3 $ , $-1$, $1$, $ 3 $}
   \tkzTabVar{+/ 2,R/, -/ -1,R/, +/ 2}
   \tkzTabIma{1}{3}{2}{$0$}
   \tkzTabIma{3}{5}{4}{$0$}
   \tkzTabLine{, +, z, -,t, -, z,+, }
...
\begin{itemize}[label=\textcolor{Couleur10}{$\bullet$}]
    \item Le domaine de définition de $f$ est $D = [-5; 5]$.
    \item Le maximum de $f$ sur $D$ est atteint en $-4$ et vaut $4$.
    \item Le minimum de $f$ sur $D$ est atteint en $4$ et vaut $-3$.
    \item Le maximum de $f$ sur $[0; 4]$ est atteint en $2$ et vaut $1$.
\end{itemize}
\end{minipage}
...
\begin{Exemple}
La fonction $f : x \mapsto x^2 - 2$, définie sur $\R$ est paire. \\
...
Courbe représentative d'une fonction paire\\
\begin{center}
