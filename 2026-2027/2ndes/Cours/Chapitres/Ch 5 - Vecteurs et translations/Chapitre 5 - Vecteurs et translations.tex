...
\begin{Exemple}
\hspace{0.5cm} \begin{tikzpicture}[x=0.5cm,y=0.5cm]
% Définition des limites
\def\xmin{-6}
\def\xmax{6}
\def\ymin{-6}
...
\draw[Couleur6] (0,4) node[below]{$-0.5\overrightarrow{u}$};

\draw[->,>=latex,violet,thick] (5,2) -- (-4,-4);
\draw[violet] (0,0.2) node[below]{$-3\overrightarrow{u}$};

\draw[->,>=latex,Couleur3,thick] (-2,-4) -- (4,0);
\draw[Couleur3] (2,-1.7) node[below]{$2\overrightarrow{u}$};

\draw[->,>=latex,Couleur11,thick] (2,2) -- (-4,-2);
\draw[Couleur11] (-1.5,1.5) node[below]{$-2\overrightarrow{u}$};
...
\item $2(\overrightarrow{u}+\overrightarrow{v})=2\overrightarrow{u}+2\overrightarrow{v}$
\item $2\overrightarrow{u}+3\overrightarrow{u}=(2+3)\overrightarrow{u}=5\overrightarrow{u}$
\item $4(5\overrightarrow{u})=(4\times 5)\overrightarrow{u}=20\overrightarrow{u}$
\end{itemize}
\end{multicols}
\end{Exemple}
