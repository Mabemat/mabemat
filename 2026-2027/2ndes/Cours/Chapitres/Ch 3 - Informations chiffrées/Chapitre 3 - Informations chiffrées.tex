...
\noindent La {\bf{population totale}} des élèves de seconde, notée $\color{Couleur1}{N}$, est égale à $\color{Couleur1}{150}$. C'est la population de référence.\\
La {\bf{sous-population}} des élèves externes, notée $\color{Couleur10}{n}$, est égale à $\color{Couleur10}{36}$.\\
La  {\bf{proportion}} d'élèves externes parmi tous les élèves de seconde, notée $p$, est : 
$p=\dfrac{\color{Couleur10}{n}}{\color{Couleur1}{N}}=\dfrac{\color{Couleur10}{36}}{\color{Couleur1}{150}}=\dfrac{6}{25}=0,24$
Cette proportion peut s'exprimer en {\bf{pourcentage}} : $p = 24\%$.
\end{minipage} \hfill
...
\begin{Exemple}
Parmi les $150$ élèves de seconde, $12\%$ ont choisi comme deuxième langue l'allemand. \\
$12\% \quad \color{Couleur3}{\text{de}} \quad \color{Couleur1}{150}$ \quad ont choisi l'allemand, soit : $12\%  {\color{Couleur3}{\times}} {\color{Couleur1}{150}}=\dfrac{12}{100}{\color{Couleur3}{\times}}  {\color{Couleur1}{150}} =18 $ élèves.
\end{Exemple}
...
$12\%$ de $75$= $\dfrac{12}{100} \times 75=9$. Cette société compte 9 cadres.

\item Calculer la proportion de femmes dans cette société.

$n = 35$ femmes et $N = 75$ employés.\\
...
$n = 5$ femmes cadres et $N = 35$ femmes. La population de référence n'est plus la même.\\
...
$${\color{Couleur10}{60\%}} \text{ de } {\color{Couleur1}{35\%}} ={\color{Couleur10}{60\%}} \times {\color{Couleur1}{35\%}} = {\color{Couleur10}{0,6}}\times {\color{Couleur1}{0,35}} =0,21 =21\%$$
\end{minipage} \hfill
\begin{minipage}[c]{0.5\linewidth}
\begin{center} 
\begin{tikzpicture}[scale=.75] 
...
$T$ est la population en âge de travailler.\\ $A$ est la population active.\\
La proportion de $A$ dans $T$ est $70\%$.\\
La proportion de $T$ dans $F$ est $66\%$.\\
La proportion de $A$ dans $F$ est donc égale à : $$70 \% \times 66 \% = 0,7 \times 0,66 = 0,462 = 46,2 \%$$
$46,2 \%$ des français sont actifs.

\item Combien de français compte la population active ?

$$46,2 \% \text{ de } 67 = 0,462 \times 67 = 30,954$$
...
Son nouveau prix est égal à : $\left(1+\dfrac{8}{100}\right)\times 49=1,08\times 49= 52,25$€.
\item Le prix d'un polo est de $21$€. Il est soldé de $20\%$. \\
Son nouveau prix est égal à : $\left(1-\dfrac{20}{100}\right)\times 21=0,8\times 21= 16,8$€.
\end{itemize}
\end{Exemples}
...
\leavevmode\vspace{-\baselineskip}
\begin{itemize}
\item La population d'un village est passé de $8\,500$ à $10\,400$ entre $2008$ et $2012$.
$$t=\dfrac{10\,400-8\,500}{8\,500}\approx 0,224$$
La population a augmenté de $22,4\%$.

\item Le prix d'une console passe de $399$€ à  $349$€. 
$$t=\dfrac{349-399}{399}\approx -0,125$$
Le prix de la console a donc diminué de $12,5\%$.
\end{itemize}
\end{Exemples}
...
On a $1+T=\left(1+\dfrac{20}{100}\right)\left(1-\dfrac{25}{100}\right)=1,2\times 0,75=0,9=1-\dfrac{10}{100}$. Le jouet au global a subi une diminution de $10\%$. \\
...
On a $1+t=\left(1+\dfrac{11}{100}\right)=1,11$. Le taux réciproque est de $t'=\dfrac{1}{1,11}-1$. \\
